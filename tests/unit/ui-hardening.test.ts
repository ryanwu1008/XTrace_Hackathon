...
test("underwriting queue and editorial memo use readable responsive layouts", async () => {
  ...
  for (const contract of [
    ...
    ".vsee-action-draft-body{",
    "white-space:pre-wrap;",
    "max-width:82ch;",
    ".vsee-action-draft-content>summary,",
    ".vsee-action-draft-audit dl{grid-template-columns:1fr}",
  ...
  return {
    ...
    evidencePack: {
      ...
      facts: [{
        ...
        sourceAction: { kind: "stored_source_revision", page: null },
