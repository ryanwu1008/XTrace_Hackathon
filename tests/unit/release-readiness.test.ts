...
const migrationNames = [
  ...
  "0029_xtrace_final_authority.sql",
  "0030_xtrace_recall_audit_authority.sql",
];
...
test("the physical migration chain is contiguous from 0000 through 0030", async () => {
...
test("journaled forward migrations preserve physical order and include 0010 through 0030", async () => {
  ...
  assert.deepEqual(
    actualForwardEntries.filter((tag) => /^(?:001[0-9]|002[0-9]|0030)_/.test(tag)),
